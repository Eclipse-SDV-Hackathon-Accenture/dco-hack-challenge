...
// metadata
:description: Documentation of Release-management-service.
:keywords: architecture, microservice, documentation, Release-management-service
//settings
:toc: left
:icons: font
:sectnums:
...
[IMPORTANT]
====
This content was published by automation. Do not edit here but in source code.
====
endif::automation[]
