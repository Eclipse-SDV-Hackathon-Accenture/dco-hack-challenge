...
public class SimulationQuery {
  ...
  public SimulationQuery(String query) {
  ...
  public SimulationQuery isValid() {
    if (queries.isEmpty()) {
  ...
  public Specification<SimulationEntity> toSpecification() {
    if (queries.isEmpty()) {
      return null;
    }
    Specification<SimulationEntity> result = queries.get(0);
  ...
  public static class Query implements Serializable, Specification<SimulationEntity> {
